...
namespace BootcampThanos.DataAccess.Repositories
{
    public class ProductLineRepository : IProductLineRepository
    {
        ...
        {
            Productline productToUpdate = ProductLineMapper.MapToProductLineFromProductLineDto(productLine);

            var productUpdated = _context.Productlines.Update(productToUpdate);
