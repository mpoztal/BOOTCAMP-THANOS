...
// SIEMPRE ES IMPORT  'algo' FROM (le indicamos archivo donde queremos esa operacion)
...
/ dividir
`)
// ¡¡ CUIDADO CON LA IMPORTACION. Hay que indicar en el html que el js es de tipo module!!
